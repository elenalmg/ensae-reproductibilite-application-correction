...
parser = argparse.ArgumentParser(description="Combien d'arbres souhaitez vous ?")
parser.add_argument(
    "--ntrees", type=int, default=20, help="Un nombre d'arbre à choisir"
)
args = parser.parse_args()
print(args.ntrees)

rdmf = RandomForestClassifier(n_estimators=args.ntrees)
